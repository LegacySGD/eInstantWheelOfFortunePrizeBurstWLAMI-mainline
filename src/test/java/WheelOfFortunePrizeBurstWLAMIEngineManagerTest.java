...
public class WheelOfFortunePrizeBurstWLAMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortunePrizeBurstWLAMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstWLAMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstWLAMIIW/InitOutcome.xml").getDocumentElement();
